        ...
        <section className="space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5">
            {services.map((service) => (
              ...
              >
                <h3 className="text-xl font-semibold leading-snug text-zinc-950 transition group-hover:text-zinc-700">
                  {service.title}
                </h3>
                <p className="mt-4 whitespace-normal break-words text-sm leading-6 text-zinc-600">
                  {service.description}
                </p>
              </article>
            ))}
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-zinc-950 px-6 py-3 text-sm font-semibold text-white shadow-glow transition hover:bg-zinc-800"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-300 px-6 py-3 text-sm font-semibold text-zinc-900 transition hover:border-zinc-500 hover:text-zinc-950"
              >
